...
import 'package:task2_project/pages/pages.dart';
import 'package:task2_project/providers/providers.dart';
import 'package:task2_project/utils/utilities.dart';
import 'package:task2_project/widgets/widgets.dart';
...
class ChatPageState extends State<ChatPage> {
 ...
 void _readLocal() {
  ...
  // ✅ stable groupChatId (quan trọng nhất)
  _groupChatId = _currentUserId.hashCode <= peerId.hashCode
      ? '$_currentUserId-$peerId'
      : '$peerId-$_currentUserId';

  // ✅ đảm bảo node tồn tại trong Firestore (fix “xoay mãi không load chat”)
                ...
                ? Container(
                    child: Text(
                      DateFormat('dd MMM kk:mm')
                          .format(DateTime.fromMillisecondsSinceEpoch(messageChat.timestamp)),
